...
export const listOfAwesome = [
  ...
  { id: '4', name: 'Evelyn Boyd Granville' },
  { id: '5', name: 'Mary Kenneth Keller' },
  { id: '6', name: 'Frances Allen' },
  { id: '7', name: 'Carol Shaw' },
];
...
export default function Programmers() {
  ...
  const getNameOfFeatured = () => {
    ...
    const featuredProgrammer = programmers.filter((obj) => {return obj.id == featuredID});
    return featuredProgrammer[0].name;
  };
